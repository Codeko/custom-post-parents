...
class CustomPostParentsAdminPage {
    ...
    private function __construct() {
        ...
        add_action('admin_enqueue_scripts', function ($hook_suffix) {
            ...
            wp_enqueue_script( 'custom_post_parents_admin', site_url() . '/wp-content/plugins/custom-post-parents/js/custom-post-parents-admin.js');
            $data = array(
            ...
            wp_localize_script('custom_post_parents_admin','data',$data);
        });
